...
int main(void){
    int dep1, arr1, dep2, arr2, dep3, arr3, dep4, arr4, 
	dep5, arr5, dep6, arr6, dep7, arr7, dep8, arr8;
    dep1 = 8 * 60;
    arr1 = 10 * 60 + 16;
    dep2 = 9 * 60 + 43;
    arr2 = 11 * 60 + 52;
    ...
    if(closestDepHr == 0) closestDepHr = 12;
    if(closestArrHr == 0) closestArrHr = 12;
	...
	printf("Closest departure time is %d:%.2d p.m., arriving at %d:%.2d a.m.\n", 
	    closestDepHr, closestDepMin, closestArrHr, closestArrMin);
    else if(depAM && !arrAM)
