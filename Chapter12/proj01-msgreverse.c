// reverses a sentence entered by the user using subscripting and pointer
// arithmetic
//
// I don't think the project requires you to actually reverse the array and you
// can just print the array backwards
...
void msgReversePointer(int n, char msg[n]) {
    for (char *l = &msg[0], *r = &msg[n - 1]; l < r; ++l, --r) {
        char tmp = *l;
        *l = *r;
        *r = tmp;
    }
